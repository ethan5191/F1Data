...
public class LapDataFactory implements DataFactory<LapData> {

    private final SupportedYearsEnum packetFormat;

    public LapDataFactory(int packetFormat) {
        this.packetFormat = SupportedYearsEnum.fromYear(packetFormat);
    }

    public LapData build(ByteBuffer byteBuffer) {
        return switch (packetFormat) {
            case F1_2019 -> buildData(new LapData.LapData19(byteBuffer));
    ...
    private LapData buildData(LapData.LapData19 l19) {
        return new LapData(0, 0, 0, 0, 0, 0,
    ...
    private LapData buildData(LapData.LapData20 l20) {
        return new LapData(0, 0, l20.sector1TimeMsPart(), 0, l20.sector2TimeMsPart(), 0,
    ...
    private LapData buildData(LapData.LapData21 l21) {
        return new LapData(l21.lastLapTimeMs(), l21.currentLapTimeMs(), l21.sector1TimeMsPart(), 0, l21.sector2TimeMsPart(), 0,
    ...
    private LapData buildData(LapData.LapData23 l23) {
        return new LapData(l23.lastLapTimeMs(), l23.currentLapTimeMs(), l23.sector1TimeMsPart(), l23.sector1TimeMinutesPart(), l23.sector2TimeMsPart(), l23.sector2TimeMinutesPart(),
    ...
    private LapData buildData(LapData.LapData24 l24) {
        return new LapData(l24.lastLapTimeMs(), l24.currentLapTimeMs(), l24.sector1TimeMsPart(), l24.sector1TimeMinutesPart(), l24.sector2TimeMsPart(), l24.sector2TimeMinutesPart(),
