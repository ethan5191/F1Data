 ...
 * m_gameMajorVersion             | uint8     | 1            | 3               | 2019
 * m_gameMinorVersion             | uint8     | 1            | 4               | 2019
 * m_packetVersion                | uint8     | 1            | 5               | 2019
 * m_packetId                     | uint8     | 1            | 6               | 2019
 * m_sessionUID                   | uint64    | 8            | 7               | 2019
 * m_sessionTime                  | float     | 4            | 15              | 2019
 * m_frameIdentifier              | uint32    | 4            | 19              | 2019
 * m_overallFrameIdentifier       | uint32    | 4            | 23              | 2023
 * m_playerCarIndex               | uint8     | 1            | 27              | 2019
...
public record PacketHeader(int packetFormat, int majorVersion, int minorVersion, int packetVersion, int packetId,
    ...
    record PacketHeader19(int packetFormat,
                          int majorVersion,
                          int minorVersion,
                          int packetVersion,
                          int packetId,
                          ...
                          long frameID,
                          int playerCarIndex) {
        public PacketHeader19(int packetFormat, ByteBuffer byteBuffer) {
            this(
                    packetFormat,
