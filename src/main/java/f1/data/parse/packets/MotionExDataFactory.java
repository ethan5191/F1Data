...
public class MotionExDataFactory implements DataFactory<MotionExData> {
    ...
    public MotionExDataFactory(int packetFormat) {
        this.packetFormat = SupportedYearsEnum.fromYear(packetFormat);
    }

    public MotionExData build(ByteBuffer byteBuffer) {
    ...
    private MotionExData buildData(MotionExData.MotionExData23 med23) {
        return new MotionExData(med23.suspensionPosition(), med23.suspensionVelocity(), med23.suspensionAcceleration(), med23.wheelSpeed(),
    ...
    private MotionExData buildData(MotionExData.MotionExData24 med24) {
        return new MotionExData(med24.suspensionPosition(), med24.suspensionVelocity(), med24.suspensionAcceleration(), med24.wheelSpeed(),
    ...
    private MotionExData buildData(MotionExData.MotionExData25 med25) {
        return new MotionExData(med25.suspensionPosition(), med25.suspensionVelocity(), med25.suspensionAcceleration(), med25.wheelSpeed(),
