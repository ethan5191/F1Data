...
public class CarDamageDataFactory implements DataFactory<CarDamageData>, FirstYearProvided {
    ...
    private CarDamageData buildData(CarDamageData.CarDamageData22 c22) {
        return new CarDamageData(c22.tyresWear(), c22.tyresDamage(), c22.brakesDamage(), c22.frontLeftWingDamage(), c22.frontRightWingDamage(), c22.rearWingDamage(),
                ...
                c22.ersFault(), c22.engineBlown(), c22.engineSeized(), new int[4]);
    }

    private CarDamageData buildData(CarDamageData.CarDamageData25 c25) {
        return new CarDamageData(c25.tyresWear(), c25.tyresDamage(), c25.brakesDamage(), c25.frontLeftWingDamage(), c25.frontRightWingDamage(), c25.rearWingDamage(),
                c25.floorDamage(), c25.diffuserDamage(), c25.sidepodDamage(), c25.drsFault(), c25.gearBoxDamage(), c25.engineDamage(),
                c25.engineMGUHWear(), c25.engineESWear(), c25.engineCEWear(), c25.engineICEWear(), c25.engineMGUKWear(), c25.engineTCWear(),
                c25.ersFault(), c25.engineBlown(), c25.engineSeized(), c25.tyreBlisters());
    }
