...
public class CarDamageDataFactory implements DataFactory<CarDamageData> {
    ...
    public CarDamageData build(ByteBuffer byteBuffer) {
        return switch (packetFormat) {
            case F1_2020, F1_2021 -> buildDamageData(new CarDamageData.CarDamageData20(byteBuffer));
            case F1_2022, F1_2023, F1_2024, F1_2025 -> buildDamageData(new CarDamageData.CarDamageData22(byteBuffer));
            default ->
                    throw new IllegalStateException("Games Packet Format did not match an accepted format (2020 - 2025)");
        };
    }

    private CarDamageData buildDamageData(CarDamageData.CarDamageData20 c20) {
    ...
    private CarDamageData buildDamageData(CarDamageData.CarDamageData22 c22) {
