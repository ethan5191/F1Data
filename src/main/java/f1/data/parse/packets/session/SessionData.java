 ...
 * - m_activeAeroTrackStatus      | uint8     | 1            | 2026           | 0 = Full, 1 = Partial
 * - m_numActiveAeroZonesFull     | uint8     | 1            | 2026           | Number of Active Aero zones to follow
 * - m_activeAeroZonesFull        | struct[8] | 64           | 2026           | List of Active Aero zones - max 8
 * - m_numActiveAeroZonesPartial  | uint8     | 1            | 2026           | Number of Active Aero zones to follow
 * - m_activeAeroZonesPartial     | struct[8] | 64           | 2026           | List of Active Aero zones - max 8
 * - m_numDRSZones                | uint8     | 1            | 2026           | Number of DRS zones to follow
 * - m_drsZones                   | struct[4] | 32           | 2026           | List of DRS zones - max 4
 * - m_startReactionTime          | float     | 4            | 2026           | Driver start reaction time in seconds, 0.0f if assisted starts
 * - m_antiLockBrakesAssist       | uint8     | 1            | 2026           | 0 = Off, 1 = On
 * - m_tractionControlAssist      | uint8     | 1            | 2026           | 0 = Off, 1 = Medium, 2 = Full
 * - m_dynamicRacingLineHiVis     | uint8     | 1            | 2026           | 0 = Off, 1 = On
 * - m_dynamicRacingLineColourBlind | uint8   | 1            | 2026           | 0 = Off, 1 = Protanopia, 2 = Deuteranopia, 3 = Tritanopia
 * - m_recurringRewindPrompt      | uint8     | 1            | 2026           | 0 = Off, 1 = On
 */
...
public record SessionData(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
                          ...
                          float sector3LapDistanceStart, TwentySixSessionData twentySixSessionData) {

    public static final int WEATHER_FORECAST_20_SIZE = 20;
    public static final int WEATHER_FORECAST_21_TO_23_SIZE = 56;
    public static final int WEATHER_FORECAST_24_NEWER_SIZE = 64;

    public static final int ACTIVE_AERO_ZONE_SIZE = 8;
    public static final int DRS_ZONE_SIZE = 4;
    ...
    public record SessionData20(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
        ...
        public SessionData20(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples20(packetFormat, byteBuffer));
        }
    }
    ...
    public record SessionData21(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
        ...
        public SessionData21(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples21(packetFormat, byteBuffer, WEATHER_FORECAST_21_TO_23_SIZE), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new AssistData(byteBuffer));
        }
    }
    ...
    public record SessionData22(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
        ...
        public SessionData22(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples21(packetFormat, byteBuffer, WEATHER_FORECAST_21_TO_23_SIZE), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new AssistData(byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()));
        }
    }
    ...
    public record SessionData23(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
        ...
        public SessionData23(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples21(packetFormat, byteBuffer, WEATHER_FORECAST_21_TO_23_SIZE), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new AssistData(byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()));
        }
    }
    ...
    public record SessionData24(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
        ...
        public SessionData24(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples21(packetFormat, byteBuffer, WEATHER_FORECAST_24_NEWER_SIZE), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new AssistData(byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new GameModeData(byteBuffer), byteBuffer.getFloat(), byteBuffer.getFloat());
        }
    }

    public record SessionData26(int weather, int trackTemperature, int airTemperature, int totalLaps, int trackLength,
                                int sessionType, int trackId, int formula, int sessionTimeLeft, int sessionDuration,
                                int pitSpeedLimit, int gamePaused, int isSpectating, int spectatorCarIndex,
                                int sliProNativeSupport, int numMarshalZones, MarshalZoneData[] marshalZones,
                                int safetyCarStatus, int networkGame, int numWeatherForecastSamples,
                                ...
                                int speedUnitsSecondaryPlayer, int tempUnitsSecondaryPlayer, int numSafetyCarPeriods,
                                int numVirtualSafetyCarPeriods, int numRedFlagPeriods, GameModeData gameModeData,
                                float sector2LapDistanceStart, float sector3LapDistanceStart, TwentySixSessionData twentySixSessionData) {
        public SessionData26(int packetFormat, ByteBuffer byteBuffer) {
            this(BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), byteBuffer.get(), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask16(byteBuffer.getShort()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildMarshalZones(packetFormat, byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), buildWeatherForecastSamples21(packetFormat, byteBuffer, WEATHER_FORECAST_24_NEWER_SIZE), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new AssistData(byteBuffer), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask32(byteBuffer.getInt()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), BitMaskUtils.bitMask8(byteBuffer.get()), new GameModeData(byteBuffer), byteBuffer.getFloat(), byteBuffer.getFloat(), new TwentySixSessionData(packetFormat, byteBuffer));
        }
    }
}
