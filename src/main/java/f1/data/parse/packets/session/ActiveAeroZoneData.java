...
public record ActiveAeroZoneData(float zoneStart, float zoneEnd) {

/**
 *  - F1 2026 ActiveAeroZoneData Length: 8 bytes
 * <p>
 ...
 */
    ...
    public ActiveAeroZoneData(ByteBuffer byteBuffer) {
        this(
