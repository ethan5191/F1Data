...
//Object is used to ensure that if you use a flashback during a session, the data doesn't get reset due to the session time left, being more than previous value.
