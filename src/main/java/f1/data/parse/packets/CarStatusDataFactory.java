...
public class CarStatusDataFactory implements DataFactory<CarStatusData> {

    private final SupportedYearsEnum packetFormat;

    public CarStatusDataFactory(int packetFormat) {
        this.packetFormat = SupportedYearsEnum.fromYear(packetFormat);
    }

    public CarStatusData build(ByteBuffer byteBuffer) {
        return switch (this.packetFormat) {
            case F1_2019 -> buildData(new CarStatusData.CarStatusData19(byteBuffer));
    ...
    private CarStatusData buildData(CarStatusData.CarStatusData19 c19) {
        return new CarStatusData(c19.tractionControl(), c19.antiLockBrakes(), c19.fuelMix(), c19.frontBrakeBias(), c19.pitLimitStatus(),
    ...
    private CarStatusData buildData(CarStatusData.CarStatusData20 c20) {
        return new CarStatusData(c20.tractionControl(), c20.antiLockBrakes(), c20.fuelMix(), c20.frontBrakeBias(), c20.pitLimitStatus(),
    ...
    private CarStatusData buildData(CarStatusData.CarStatusData21 c21) {
        return new CarStatusData(c21.tractionControl(), c21.antiLockBrakes(), c21.fuelMix(), c21.frontBrakeBias(), c21.pitLimitStatus(),
    ...
    private CarStatusData buildData(CarStatusData.CarStatusData23 c23) {
        return new CarStatusData(c23.tractionControl(), c23.antiLockBrakes(), c23.fuelMix(), c23.frontBrakeBias(), c23.pitLimitStatus(),
