    ...
    public static LobbyInfoData build(int packetFormat, ByteBuffer byteBuffer) {
        ...
        return switch (packetFormat) {
            case Constants.YEAR_2020:
                ...
                yield new LobbyInfoData(lid20.aiControlled(), lid20.teamId(), lid20.nationality(), lid20.name(), lid20.readyStatus(), 0, 0, 0, 0, 0);
            case Constants.YEAR_2021, Constants.YEAR_2022:
                ...
                yield new LobbyInfoData(lid21.aiControlled(), lid21.teamId(), lid21.nationality(), lid21.name(), lid21.readyStatus(), lid21.carNumber(), 0, 0, 0, 0);
