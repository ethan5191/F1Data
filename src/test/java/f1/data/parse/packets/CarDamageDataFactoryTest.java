...
public class CarDamageDataFactoryTest extends AbstractFactoryTest {
    ...
    void testBuild_carDamage2020To2021(int packetFormat) {
        ...
        try (MockedStatic<BitMaskUtils> bitMaskUtils = mockStatic(BitMaskUtils.class);
            ...
            assertArrayEquals(intArray, result.tyreBlisters());
        }
    }

    @ParameterizedTest
    @MethodSource("supportedYears2022To2024")
    @DisplayName("Builds the Car Damage Data from 2022 to 2024.")
    void testBuild_carDamage2022To2024(int packetFormat) {
    ...
    @DisplayName("Builds the Car Damage Data from 2025 to Present.")
