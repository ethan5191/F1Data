...
public class CarStatusDataFactoryTest extends AbstractFactoryTest {
    ...
    static Stream<Integer> supportedYears2023To2025() {
    ...
    @ParameterizedTest
    @MethodSource("supportedYears2023To2025")
    @DisplayName("Builds the Car Status Data for 2023 to 2025.")
    void testBuild_carStatus2023To2025(int packetFormat) {
        int bitMask8Count = 12;
        int bitMask16Count = 3;
        int floatCount = 9;
        int bitMask8Value = BIT_8_START;
    ...
    @DisplayName("Builds the Car Status Data for 2026 To Present.")
    void testBuild_carStatus2026ToPresent(int packetFormat) {
        int bitMask8Count = 12;
        int bitMask16Count = 3;
        int floatCount = 10;
        int bitMask8Value = BIT_8_START;
        ...
        try (MockedStatic<BitMaskUtils> bitMaskUtils = mockStatic(BitMaskUtils.class);
            ...
            assertEquals(floatValue++, result.ersHarvestedThisLapMGUK());
            assertEquals(floatValue++, result.ersHarvestedThisLapMGUH());
            assertEquals(floatValue++, result.ersHarvestLimitPerLap());
            assertEquals(floatValue++, result.ersDeployedThisLap());
            assertEquals(bitMask8Value++, result.networkPaused());
